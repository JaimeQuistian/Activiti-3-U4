...
{
    //Se le asigna el operador : para permitir el paso de datos heredados de la clase Persona a la clase VacunaCansino.
    class VacunaCansino : Vacuna
    {
        ...
        public VacunaCansino(int dosis, string nombrePersona, string apellidoPrimero, string apellidoSegundo, DateTime fechaNacimiento,
            int lugarAplicaion)
