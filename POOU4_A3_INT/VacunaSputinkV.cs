...
{
    //Se le asigna el operador : para permitir el paso de datos heredados de la clase Persona a la clase VacunaSputinkV.
    class VacunaSputinkV : Vacuna
    {
        ...
        public VacunaSputinkV(int dosis, string nombrePersona, string apellidoPrimero, string apellidoSegundo, DateTime fechaNacimiento,
            int lugarAplicaion)
